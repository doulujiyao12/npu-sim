 ...
 * Declare a option which accept only one parameter, so you can access it by
 * using Flag_* vairable.
 * @{
 */
 ...
 * Declare a option which accept parameters list, so you can access it by using
 * Flag_* variable
 */
 ...
 * Declare a self-defined option which accept only one parameter, so you can
 * access it by using Flag_* variable
 * @{
 */
 ...
 * Declare a self-define option which accept parameter list, so you can access
 * it by using Flag_* variable.
 * @{
 */
