...
void sram_first_write_generic(TaskCoreContext &context, int data_size_in_byte,
                              ...
                              float *dram_start, std::string label_name = "default_key", bool use_manager = false, SramPosLocator *sram_pos_locator = nullptr, bool dummy_alloc = false);
...
void sram_write_append_generic(TaskCoreContext &context, int data_size_in_byte,
                               u_int64_t &dram_time, std::string label_name = "default_key", bool use_manager = false, SramPosLocator *sram_pos_locator = nullptr);
