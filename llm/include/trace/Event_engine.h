...
public:
    ...
    void add_event(string _module_name, string _thread_name, string _type, Trace_event_util _util, sc_time relative_time = sc_time(0, SC_NS), unsigned flow_id = 0, string bp = "");
...
public:
    ...
    map<pair<string, string>, unsigned> thread_idx; // 模块名和线程名到 TID 的映射
